...
HD_PWD='D:/fpga/CORDIC/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CORDIC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CORDIC.tcl -notrace
