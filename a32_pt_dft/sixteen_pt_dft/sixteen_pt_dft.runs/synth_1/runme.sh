...
HD_PWD='D:/fpga/sixtte_pt_dft/sixteen_pt_dft/sixteen_pt_dft.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft16point_TB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft16point_TB.tcl
